<?= headerView() ?>
    ...
    <?=begin_JqGridPanel('gridPerguntas', 'auto', '', base_url().'coordenador/perguntas/listaPerguntas/', array('sortname'=> 'descricao', 'autowidth'=> true, 'toppager' => false, 'rowNum' => 15, 'pager'=> true, 'caption'=>lang('listaPerguntas')));?>
...
<script type="text/javascript">
    ...
    function gridPerguntas_click(id){
        location.href = BASE_URL+'coordenador/perguntas/editar/'+id;
    }
    ...
    function excluirPerguntas(confirmaExclusao){
        if (confirmaExclusao) {
            ...
            $.post(BASE_URL+'coordenador/perguntas/excluir/', {id: perguntas},
            function(data){
                if (data.success) {
