<?= headerView() ?>
    ...
    <?=end_TabPanel();?>
        ...
        <?=begin_JqGridPanel('gridPesquisas', 'auto', '', base_url().'coordenador/peopleplanPesquisa/listaPesquisas/', array('sortname'=> 'nome', 'autowidth'=> true, 'toppager' => false, 'rowNum' => 15, 'pager'=> true, 'caption'=>lang('pesquisaListaPesquisas')));?>
...
<script type="text/javascript">
    ...
    function gridPesquisas_click(id){
        location.href = BASE_URL+'coordenador/peopleplanPesquisa/editar/'+id;
    }
    ...
    function excluirPesquisas(confirmaExclusao){
        if (confirmaExclusao) {
            ...
            $.post(BASE_URL+'coordenador/peopleplanPesquisa/excluir/', {pesquisas: pesquisas},
            function(data){
                if (data.success) {
