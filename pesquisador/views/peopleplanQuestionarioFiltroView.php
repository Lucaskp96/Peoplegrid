<?= headerView() ?>
    ...
    <?=begin_JqGridPanel('gridQuestionarios', 'auto', '', base_url().'pesquisador/peopleplanQuestionario/listaQuestionarios/', array('sortname'=> 'descricao', 'autowidth'=> true, 'toppager' => false, 'rowNum' => 15, 'pager'=> true, 'caption'=>lang('pesquisadorListaQuestionarios')));?>
...
<script type="text/javascript">
    ...
    function gridQuestionarios_click(id){
        location.href = BASE_URL+'pesquisador/peopleplanQuestionario/editar/'+id;
    }
    ...
    function excluirQuestionarios(confirmaExclusao){
        if (confirmaExclusao) {
            ...
            $.post(BASE_URL+'pesquisador/peopleplanQuestionario/excluir/', {questionarios: questionarios},
            function(data){
                if (data.success) {
