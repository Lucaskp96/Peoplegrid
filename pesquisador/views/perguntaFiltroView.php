<?= headerView() ?>
    ...
    <?=begin_JqGridPanel('gridPerguntas', 'auto', '', base_url().'pesquisador/pergunta/listaPerguntas/', array('sortname'=> 'descricao', 'autowidth'=> true, 'toppager' => false, 'rowNum' => 15, 'pager'=> true, 'caption'=>lang('listaPerguntas')));?>
...
<script type="text/javascript">
    ...
    function gridPerguntas_click(id){
        location.href = BASE_URL+'pesquisador/pergunta/editar/'+id;
    }
    ...
    function excluirPerguntas(confirmaExclusao){
        if (confirmaExclusao) {
            ...
            $.post(BASE_URL+'pesquisador/pergunta/excluir/', {id: perguntas},
            function(data){
                if (data.success) {
