...
<?=path_bread($path_bread);?>
    ...
    <?=begin_TabPanel();?>
        <?=begin_Tab(lang('questionarioApuracao'));?>
            <?=begin_form('pesquisador/resultado/gerarResultado', 'formResultado');?>
        ...
        <?=begin_Tab('Cores');?>
            <?=begin_form('pesquisador/resultado/salvarCores', 'formCores');?>             
                   <div id="pickers">
                    <div>
...
<script>
    ...
    function exportar(){
        ...
        $.ajax({
            url:BASE_URL+"/pesquisador/resultado/gerarResultado/",
            dataType: "json",
            type:'post',
            data:{
            ...
            success : 
                function(data){
                    if(data.error != undefined){
                        ...
                        $.ajax({
                            url:BASE_URL+"/pesquisador/resultado/exportar/",
                            dataType: "json",
                            type:'post',
                            data:{
                                    distancia: distancia,
    ...
    */
	...
	$("#sliderClasses").slider({
		...
		$.ajax({
			url:BASE_URL+"/pesquisador/resultado/salvarCores/",
			dataType: "json",
			data:{
				id: cores_id,
