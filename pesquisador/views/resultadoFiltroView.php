<?= headerView() ?>
	...
	<?=end_TabPanel();?>
        ...
        <?=begin_JqGridPanel('gridQuestionariosResultados', 'auto', '', base_url().'pesquisador/resultado/listaQuestionarios/', array('sortname'=> 'descricao', 'autowidth'=> true, 'toppager' => false, 'rowNum' => 15, 'pager'=> true, 'caption'=>lang('pesquisadorListaQuestionarios')));?>
...
<script>
    ...
    function gridQuestionariosResultados_click(id){
        location.href = BASE_URL+'pesquisador/resultado/visualizar/'+id;
    }
</script>
<?= footerView() ?>