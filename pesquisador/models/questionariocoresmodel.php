...
class QuestionarioCoresModel extends Model {
    ...
    function getCoresByQuestionario($id) {
        ...
        return $this->db->get('peoplegrid.questionario_cores')->row();
    }
    
    function getCoresByQuestionarioCombo($id) {
        $this->db->where('questionario_id', $id);
        return $this->db->get('peoplegrid.questionario_cores')->result_array();
    }
