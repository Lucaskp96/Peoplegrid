...
class ResultadoModel extends Model {
    ...
    function getQuestionarioPerguntasGridByQuestionarioId($questionarioId) {
        ...
        $this->db->select('qpg.id, p.descricao');
    ...
    function getResultadosPergunta($parametros){
        ...
        $this->db->join('peoplegrid.respostas AS r', "r.id = gr.resposta_id");
        $this->db->where('gr.questionario_pergunta_grid_id', $parametros['cmbQuestionarioPerguntas']);
