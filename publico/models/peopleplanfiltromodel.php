 ...
 * @author agpeil
 */
class PeopleplanFiltroModel extends Model {
    ...
    function getPensouComo(){
        ...
        $this->db->from('peopleplan.pensou_como as pc');
    ...
    function getNivelEscolaridade(){
        ...
        $this->db->from('peopleplan.nivel_escolaridade as ne');
    ...
    function getRendaFamiliar(){
        ...
        $this->db->from('peopleplan.renda_familiar as rf');
