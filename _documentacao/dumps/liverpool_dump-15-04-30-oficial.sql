...
61	5	Teste	S	2015-04-29 09:28:10.402679-03
\.
...
SELECT pg_catalog.setval('perguntas_grid_id_seq', 61, true);
...
SELECT pg_catalog.setval('questionario_cores_id_seq', 9, true);
...
SELECT pg_catalog.setval('questionario_perguntas_grid_id_seq', 551, true);
...
SELECT pg_catalog.setval('questionarios_id_seq', 75, true);
