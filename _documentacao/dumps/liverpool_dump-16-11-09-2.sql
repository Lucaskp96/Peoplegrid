...
63	1	Locais com maior segurança?	S	2016-11-08 22:41:18.942798-02
...
SELECT pg_catalog.setval('questionario_cores_id_seq', 10, true);
...
SELECT pg_catalog.setval('questionario_perguntas_grid_id_seq', 553, true);
...
76	Novo Campus UFPel	-31.747578731227637	-52.32838670702267	12	SAT	S	S	2016-11-08	2016-11-10	1	2016-11-08 22:42:49.43208-02	-31.707499454167543	-52.39361803026486	-31.77239140210006	-52.303623828604714	295	00a6006e
\.
...
SELECT pg_catalog.setval('questionarios_id_seq', 76, true);
...
SELECT pg_catalog.setval('perguntas_id_seq', 2, true);
...
COPY questionario_cores (id, questionario_id, cor_1, cor_2, cor_3, cor_4, cor_5, cor_6, cor_7, cor_8, cor_9, cor_10) FROM stdin;
1	1	2C7BB6	64A4CC	9CCEE3	C7E5DB	ECF6C8	FEEDAA	FDC980	F89D59	E75B35	D7191C
\.
...
SELECT pg_catalog.setval('questionario_cores_id_seq', 1, true);
...
SELECT pg_catalog.setval('questionario_perguntas_multicriterio_id_seq', 1, false);
...
COPY questionarios (id, descricao, geo_lat, geo_lon, zoom, tipo_mapa, ativo_pelo_pesquisador, ativo_pelo_adm, dt_inicio, dt_fim, pessoa_id, dt_cadastro, ponto_sup_lat, ponto_sup_lng, ponto_inf_lat, ponto_inf_lng, precisao, link) FROM stdin;
1	Novo Campus UFPel	-31.747578731227637	-52.32838670702267	10	SAT	S	S	2016-11-09	2016-11-11	1	2016-11-09 16:25:42.685421-02	-31.647578731227636	-52.3956779667883	-31.763926650253183	-52.22838670702265	1800	00320032
\.
...
SELECT pg_catalog.setval('questionarios_id_seq', 1, true);
