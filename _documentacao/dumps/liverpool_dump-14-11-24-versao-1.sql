...
-- Table: peoplegrid.questionario_cores

-- DROP TABLE peoplegrid.questionario_cores;

CREATE TABLE peoplegrid.questionario_cores
(
  id serial NOT NULL,
  questionario_id integer NOT NULL,
  cor_1 character varying(6) NOT NULL DEFAULT '0592f7'::character varying,
  cor_2 character varying(6) NOT NULL DEFAULT '3787bf'::character varying,
  cor_3 character varying(6) NOT NULL DEFAULT '44779c'::character varying,
  cor_4 character varying(6) NOT NULL DEFAULT '43637a'::character varying,
  cor_5 character varying(6) NOT NULL DEFAULT '323c42'::character varying,
  cor_6 character varying(6) NOT NULL DEFAULT '020303'::character varying,
  cor_7 character varying(6) NOT NULL DEFAULT '403030'::character varying,
  cor_8 character varying(6) NOT NULL DEFAULT '613e3e'::character varying,
  cor_9 character varying(6) NOT NULL DEFAULT '9c2a2a'::character varying,
  cor_10 character varying(6) NOT NULL DEFAULT 'c91010'::character varying,
  CONSTRAINT questionario_cores_pkey PRIMARY KEY (id),
  CONSTRAINT forekey FOREIGN KEY (questionario_id)
      REFERENCES peoplegrid.questionarios (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
)
WITH (
  OIDS=FALSE
);
ALTER TABLE peoplegrid.questionario_cores
  OWNER TO postgres;

-- Index: peoplegrid.fki_forekey

-- DROP INDEX peoplegrid.fki_forekey;

CREATE INDEX fki_forekey
  ON peoplegrid.questionario_cores
  USING btree
  (questionario_id);
...
SELECT pg_catalog.setval('grid_respostas_id_seq', 87, true);
...
SELECT pg_catalog.setval('questionario_perguntas_grid_id_seq', 378, true);
...
SELECT pg_catalog.setval('respostas_id_seq', 56, true);
...
15	EDUARDO ROCHA			\N	M	\N	\N	\N	\N	\N		\N	2014-06-05 15:37:56.798849	\N	\N	D	\N	\N	\N	\N	\N	\N	\N	\N	\N	EDUARDO ROCHA
...
26	Pesquisadores		gerenciador/pesquisador		2014-08-01
...
1	1	admin	6d072a7f7b450636170c6e16a234011879950ebc	2010-02-18 22:00:01	\N	\N	flick
...
--
-- Name: configuracao_id_seq; Type: SEQUENCE; Schema: peoplegrid; Owner: postgres
--
...
--
-- Name: configuracao_id_seq; Type: SEQUENCE OWNED BY; Schema: peoplegrid; Owner: postgres
--
...
INSERT INTO configuracao(
            id, nome_perfil, email, senha, email_administrador)
    VALUES (1, 'padrao', 'peoplegrid@gmail.com', 'peoplegridAdministrador@gmail.com', '123456');
