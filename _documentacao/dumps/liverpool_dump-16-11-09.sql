...
ALTER SEQUENCE respostas_id_seq OWNED BY respostas_multicriterio.id;
...
ALTER TABLE ONLY respostas_multicriterio ALTER COLUMN id SET DEFAULT nextval('respostas_id_seq'::regclass);
...
SELECT pg_catalog.setval('perguntas_grid_id_seq', 64, true);
...
SELECT pg_catalog.setval('perguntas_id_seq', 1, false);
...
ALTER TABLE ONLY respostas_multicriterio
    ADD CONSTRAINT fk_respostas_2 FOREIGN KEY (resposta_id) REFERENCES respostas_multicriterio(id);
